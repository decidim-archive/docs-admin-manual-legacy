...
Todo eso se ha hecho en una plataforma diseñada para la colaboración abierta en el desarrollo de _software_ denominada Github^link:#ftnt5[[5]]^. Desde esta plataforma se puede acceder al código y hacer el seguimiento del desarrollo del _software_. Github está diseñado para alojar repositorios Git, pero hay otras alternativas a Github, como por ejemplo Gitlab.
