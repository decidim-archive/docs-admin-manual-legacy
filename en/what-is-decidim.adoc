...
[[h.1t3h5sf]]Figure 1 - decidim.barcelona
...
1.  [[h.2s8eyo1]]Technopolitical hybridisation
...
1.  [[h.17dp8vu]]Enhanced and multi-modal participation
...
1.  [[h.3rdcrjn]]Transparency and traceability
...
1.  [[h.lnxbz9]]Cross-cutting participation
...
1.  [[h.35nkun2]]Knowledge, technoscience and collective intelligence
...
1.  [[h.1ksv4uv]]Collective and networked participation
...
1.  [[h.44sinio]]Public-commons orientation, reappropriation and recursive participation
...
1.  [[h.2jxsxqh]]Technopolitical accessibility and training
...
1.  [[h.z337ya]]Independence, empowerment and affiliation
...
All this has been done on a platform designed for open collaboration in software development known as GitHub^link:#ftnt5[[5]]^. This platform enables access to codes and monitoring of the software's development. GitHub is designed to host Git repositories, though there are other alternatives to GitHub such as GitLab.
